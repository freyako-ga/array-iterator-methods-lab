...
const Inventorsin1500s = inventors.filter((inventor) => {
...
// Enter your solution code here:
const strings = inventors.map(inventor => {
    return "first" && "last"
})
...
// const inventorBob = inventors.toSorted((inventor a,b) => {
...
const comments = 
    ...
    let commentById = {}
    const commentbyId = comments.find(index => {
